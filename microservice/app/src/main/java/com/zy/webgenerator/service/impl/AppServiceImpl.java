...
import com.zy.webgenerator.ai.AiCodeGenTypeRoutingServiceFactory;
import com.zy.webgenerator.constant.AppConstant;
import com.zy.webgenerator.core.AiCodeGeneratorFacade;
import com.zy.webgenerator.core.builder.VueProjectBuilder;
import com.zy.webgenerator.core.handler.StreamHandlerExecutor;
...
import com.zy.webgenerator.mapper.AppMapper;
import com.zy.webgenerator.innerservice.InnerScreenshotService;
...
import com.zy.webgenerator.model.enums.ChatHistoryMessageTypeEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        return streamHandlerExecutor.doExecute(codeStream, chatHistoryService, appId, loginUser, codeGenTypeEnum); // 流结束时清理上下文
